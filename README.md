...
│                         SESSION START                                        │
├─────────────────────────────────────────────────────────────────────────────┤
│  🚀 Session Start    📁 Load Context     🗺️ Auto-Map      📋 Version Check  │
│  Git Sync Hook       CURRENT_WORK.md     Scan new files   Compare branches  │
└─────────────────────────────────────────────────────────────────────────────┘
                                    ↓ Informs ↓
┌─────────────────────────────────────────────────────────────────────────────┐
│  📄 Code Edit        🐛 Bug Fix          🤖 Agent Task                       │
│  MAP → READ → THINK  Check BUG_PATTERNS  Context from Pack                  │
└─────────────────────────────────────────────────────────────────────────────┘
                                    ↓ Triggers ↓
┌─────────────────────────────────────────────────────────────────────────────┐
│  🔍 Pre-Commit       💥 Blast Radius     ⚠️ Tier A Check   📅 Staleness      │
│  16 checks           Impact forecast     Citation required  Doc version check │
└─────────────────────────────────────────────────────────────────────────────┘
                                    ↓ Updates ↓
┌─────────────────────────────────────────────────────────────────────────────┐
│  CODE_DOC_MAP   │  INVARIANTS   │  BUG_PATTERNS  │  GOLDEN_PATHS │ DECISIONS │
│  File → Doc     │  Safety rules │  Anti-patterns │  Best practices│  ADRs    │
└─────────────────────────────────────────────────────────────────────────────┘
                                    ↓ Generates ↓
┌─────────────────────────────────────────────────────────────────────────────┐
│  📦 Session Pack     📊 Confidence       📈 Dashboard       🔄 Git Push     │
│  Save context        Score + breakdown   Auto-refresh       Commit + sync   │
└─────────────────────────────────────────────────────────────────────────────┘
```
...
├────────────────────┬─────────────────────────┬───────────────────────────┤
│   Session Start    │      Pre-Commit         │       Confidence          │
│   ↓ Reads outputs  │   ↓ Checks against      │   ↓ Guides next focus    │
│   from last session│   patterns              │   Highest penalty =       │
│   CURRENT_WORK.md  │   BUG_PATTERNS.md       │   priority                │
...
When fully configured, the dashboard shows:
...
*See `docs/images/` for full dashboard screenshots from the Nebulae project.*
